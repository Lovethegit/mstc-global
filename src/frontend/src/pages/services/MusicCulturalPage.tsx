...
const specializations = [
  {
    ...
    desc: "Professional artist management, bookings, and career development.",
    icon: "🎵",
  },
  {
    slug: "music-production",
    label: "Music Production",
    desc: "Studio recording and production across Folk, Classical, and Pop genres.",
    icon: "🎙️",
  },
];

const offerings = [
  "Artist management and talent representation",
...
const _stats = [
  { icon: Mic2, label: "Artists Managed", value: "50+" },
  { icon: Star, label: "Events Organized", value: "100+" },
  { icon: Globe, label: "Cultural Programs", value: "30+" },
  { icon: Users, label: "Audience Reached", value: "1M+" },
];

export default function MusicCulturalPage() {
    ...
    <div className="min-h-screen bg-obsidian-900 text-gold-100">
      ...
      <section className="relative min-h-[60vh] flex items-end justify-start overflow-hidden pt-20">
        <div className="absolute inset-0">
          <img
            src="https://images.unsplash.com/photo-1493225457124-a3eb161ffa5f?w=1200&h=500&fit=crop"
            alt="Music Cultural Services"
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pb-16 w-full">
          ...
          <p className="font-sans text-obsidian-100 max-w-2xl text-base md:text-lg leading-relaxed">
            Celebrating the soul of India — promoting arts, music, and cultural
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-3xl mx-auto">
            {specializations.map((s) => (
              <Link
                key={s.slug}
                to={`/services/music-cultural/${s.slug}` as never}
      ...
      <section className="py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
            <div>
              ...
              <p className="font-sans text-obsidian-100 leading-relaxed mb-5 text-sm md:text-base">
                MSTC GLOBAL's Music & Cultural Services division is dedicated to
                nurturing and promoting India's rich artistic heritage while
                creating platforms for contemporary artists to thrive. We
                believe that culture is the heartbeat of society, and we work
                tirelessly to keep it vibrant.
              </p>
              <p className="font-sans text-obsidian-100 leading-relaxed mb-5 text-sm md:text-base">
                From managing emerging musical talents to organizing large-scale
                cultural festivals, our team brings passion and professionalism
                to every project. We connect artists with audiences, sponsors
                with events, and traditions with modern expressions.
              </p>
              <p className="font-sans text-obsidian-100 leading-relaxed text-sm md:text-base">
                Our cultural exchange programs foster understanding and
                appreciation across communities, while our heritage preservation
                initiatives ensure that India's artistic legacy endures for
                future generations.
              </p>
            </div>
            <div>
          ...
          >
            <img
              src="https://images.unsplash.com/photo-1516450360452-9312f5e86fc7?w=800&h=400&fit=crop"
              alt="Music Cultural Services"
          ...
          <div className="mt-12 text-center">
            <p className="font-cormorant text-xl text-gold-400 italic mb-6">
              Let your art reach the world with MSTC GLOBAL.
            </p>
            <button
              type="button"
              onClick={() => navigate({ to: "/" })}
      ...
      <RequestFormsSection preselectedService="Music & Cultural Services" />
      <Footer />
      <BackToTop />
    </div>
  );
