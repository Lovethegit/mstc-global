...
const specializations = [
  {
    ...
    desc: "Find your ideal rental home in Ahmedabad with platform search integration.",
    icon: "🏠",
  },
  {
    slug: "commercial-rent",
    label: "Commercial Rent",
    desc: "Office and commercial spaces for rent across prime Ahmedabad locations.",
    icon: "🏢",
  },
  {
    slug: "redevelopment",
    label: "Redevelopment",
    desc: "Unlock the value in aging properties through expert redevelopment planning.",
    icon: "🔄",
  },
];

const offerings = [
  "Residential and commercial property purchase assistance",
  "Rental property management and tenant sourcing",
  "Urban redevelopment project planning",
...
const _stats = [
  { icon: Key, label: "Properties Transacted", value: "300+" },
  { icon: Search, label: "Active Listings", value: "150+" },
  { icon: RefreshCw, label: "Redevelopments", value: "25+" },
  { icon: HandshakeIcon, label: "Happy Clients", value: "500+" },
];

export default function PurchaseRentPage() {
    ...
    <div className="min-h-screen bg-obsidian-900 text-gold-100">
      ...
      <section className="relative min-h-[60vh] flex items-end justify-start overflow-hidden pt-20">
        <div className="absolute inset-0">
          <img
            ...
            alt="Purchase Rent Redevelopment"
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pb-16 w-full">
          ...
          <p className="font-sans text-obsidian-100 max-w-2xl text-base md:text-lg leading-relaxed">
            Your trusted partner for every property transaction — buying,
            renting, or transforming spaces into opportunities.
          </p>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {specializations.map((s) => (
              <Link
                key={s.slug}
                to={`/services/purchase-rent/${s.slug}` as never}
                ...
                data-ocid={`purchase.spec_${s.slug}`}
              >
      ...
      <section className="py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
            <div>
              ...
              <h2 className="font-serif text-3xl text-gold-300 mt-2 mb-6">
                Every Property, Every Need
              </h2>
              <div className="section-divider w-24 mb-8" />
              <p className="font-sans text-obsidian-100 leading-relaxed mb-5 text-sm md:text-base">
                Whether you're looking to purchase your dream home, find the
                perfect commercial space, or unlock the potential of an aging
                property through redevelopment, MSTC GLOBAL is your
                comprehensive real estate partner.
              </p>
              <p className="font-sans text-obsidian-100 leading-relaxed mb-5 text-sm md:text-base">
                Our purchase facilitation services guide buyers through every
                step — from property search and site visits to legal
                verification, negotiation, and registration. We ensure
                transparency and protect your interests throughout the
                transaction.
              </p>
              <p className="font-sans text-obsidian-100 leading-relaxed text-sm md:text-base">
                Our redevelopment expertise transforms underutilized properties
                into modern, high-value assets, creating win-win outcomes for
                property owners, developers, and communities.
              </p>
            </div>
            <div>
              <span className="font-sans text-xs tracking-[0.4em] text-gold-400 uppercase">
          ...
          >
            <img
              src="https://images.unsplash.com/photo-1570129477492-45c003edd2be?w=800&h=400&fit=crop"
              alt="Purchase Rent Redevelopment"
          ...
          <div className="mt-12 text-center">
            <p className="font-cormorant text-xl text-gold-400 italic mb-6">
              Find your perfect property with MSTC GLOBAL.
            </p>
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
              <Link
                to={"/property-portal" as never}
                className="px-8 py-3 bg-gold-600 hover:bg-gold-500 text-obsidian-900 font-sans font-semibold text-sm tracking-widest uppercase rounded-sm transition-all duration-300 shadow-gold flex items-center gap-2"
                data-ocid="purchase.search_properties_button"
              >
                <Search size={16} /> Browse Property Portal
              </Link>
              <button
                type="button"
                onClick={() => navigate({ to: "/" })}
                className="px-8 py-3 border border-gold-700/40 text-gold-400 hover:bg-obsidian-700/40 font-sans font-semibold text-sm tracking-widest uppercase rounded-sm transition-all duration-300"
              >
                Contact Us Today
              </button>
            </div>
      ...
      <RequestFormsSection preselectedService="Purchase Rent & Redevelopment" />
      <Footer />
      <BackToTop />
    </div>
  );
