...
const specializations = [
  {
    slug: "csr-fund-management",
    label: "CSR Fund Management",
    desc: "Strategic CSR programme design and fund management for corporates.",
    icon: "🤝",
  },
  {
    slug: "social-impact",
    label: "Social Impact",
    desc: "Community-driven programmes for education, health, and empowerment.",
    icon: "🌎",
  },
];

const offerings = [
  "NGO registration and compliance support",
  "CSR strategy development for corporates",
...
const _stats = [
  ...
  { icon: TreePine, label: "Green Projects", value: "40+" },
  { icon: GraduationCap, label: "Scholarships Given", value: "500+" },
  { icon: Globe, label: "Communities Served", value: "25+" },
];

export default function NgoCsrPage() {
  ...
  return (
    <div className="min-h-screen bg-obsidian-900 text-gold-100">
      ...
      <section className="relative min-h-[60vh] flex items-end justify-start overflow-hidden pt-20">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pb-16 w-full">
          ...
          <p className="font-sans text-obsidian-100 max-w-2xl text-base md:text-lg leading-relaxed">
            Creating meaningful change — driving social impact through
            purposeful initiatives that uplift communities and transform lives.
          </p>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-3xl mx-auto">
            {specializations.map((s) => (
              <Link
                key={s.slug}
                to={`/services/ngo-csr/${s.slug}` as never}
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
            <div>
              ...
              <p className="font-sans text-obsidian-100 leading-relaxed mb-5 text-sm md:text-base">
                At MSTC GLOBAL, we believe that true success is measured not
                just in profits, but in the positive impact we create in
                society. Our NGO & CSR Initiatives division helps organizations
                fulfill their social responsibilities while creating genuine,
                lasting change in communities.
              </p>
              <p className="font-sans text-obsidian-100 leading-relaxed mb-5 text-sm md:text-base">
                We assist corporates in designing and implementing meaningful
                CSR programs that align with their business values and create
                measurable social impact. From education and healthcare to
                environmental sustainability, we cover the full spectrum of
                social development.
              </p>
              <p className="font-sans text-obsidian-100 leading-relaxed text-sm md:text-base">
                Our NGO support services help non-profit organizations
                strengthen their governance, improve operational efficiency, and
                maximize their impact through better resource management and
                strategic planning.
              </p>
            </div>
            <div>
      ...
      <RequestFormsSection preselectedService="NGO & CSR Initiatives" />
      <Footer />
      <BackToTop />
    </div>
  );
